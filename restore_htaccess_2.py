...
print("Attempting to restore .htaccess from public_html_backup_php using fileop...")
res = cpanel_api("Fileman", "fileop", op="copy", sourcefiles="public_html_backup_php/.htaccess", destfiles="public_html/.htaccess")
print(res)
