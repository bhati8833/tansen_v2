            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-8 space-y-12 text-gray-700 text-sm sm:text-base leading-relaxed">
                ...
                <article id="sec-8" className="scroll-mt-28 space-y-3 pb-8 border-b border-gray-100">
                  ...
                  <p className="text-orange-900 bg-orange-50 p-3.5 rounded-xl border border-orange-200 text-xs sm:text-sm font-medium">
                ...
                <article id="sec-14" className="scroll-mt-28 space-y-4 pt-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    >
                      <span className="font-bold text-sm text-gray-900 group-hover:text-[#E37216]">Privacy Policy</span>
                    ...
                    <Link
                      ...
                      className="p-4 bg-gray-50 hover:bg-orange-50 rounded-2xl border border-gray-200 hover:border-[#E37216] transition-all flex items-center justify-between group"
                    >
                      <span className="font-bold text-sm text-gray-900 group-hover:text-[#E37216]">Terms of Service</span>
                      <ChevronRight className="w-4 h-4 text-gray-400 group-hover:text-[#E37216]" />
                    </Link>
